...
skills: olakai-get-started, olakai-new-project, olakai-integrate, olakai-troubleshoot, olakai-reports, olakai-planning, olakai-monitor-claude-code
...
| Wants to monitor Claude Code / local agent | `olakai-monitor-claude-code` |
